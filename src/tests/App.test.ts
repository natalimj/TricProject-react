...
const accessToken = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJtb2QiLCJpYXQiOjE2NzA1ODU4ODYsImV4cCI6MTY3MDg0NTA4Nn0.npxyH8kr8ytt_kXSCbqfjUnjq0YXBm9PuaZBb3L7GIvcjTAcpo2okP9pczEIcbwqFe59TyPqdnODt-aDTv522w";
let browser;
let adminPage;
let userPage;
